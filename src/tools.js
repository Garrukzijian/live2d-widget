...
function showHitokoto() {
    ...
    fetch("https://v1.hitokoto.cn")
        ...
        .then(result => {
            const text = `This come form <span>「${result.from}」</span>，是 <span>${result.creator}</span> push on hitokoto.cn。`;
...
const tools = {
    ...
    "photo": {
        ...
        callback: () => {
            showMessage("Am I look pretty?", 6000, 9);
    ...
    "quit": {
        ...
        callback: () => {
            ...
            showMessage("May you reunite with important people someday.", 2000, 11);
